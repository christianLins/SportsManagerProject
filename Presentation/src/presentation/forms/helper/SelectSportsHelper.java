 ...
 * @author Lucia
 */
public class SelectSportsHelper extends AbstractMainForm {
    private List<String> selSports;
     ...
     */
    public SelectSportsHelper(List<String> allSports, AbstractMainForm parent) {
        this.allSports = allSports;
        this.parent = parent;
        selSports = new LinkedList<>();
        initComponents();
        setVisible(true);
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        Object[] listSelection = listSports.getSelectedValues();
                
        for(Object o : listSelection){
            selSports.add(o.toString());
        }        
        
        parent.setTxtFieldSports(getSelected());
