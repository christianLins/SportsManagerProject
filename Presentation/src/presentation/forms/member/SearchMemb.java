 ...
 * @author Lucia
 */
public class SearchMemb extends AbstractMainForm {
     ...
     */
    public SearchMemb(AbstractForm form, ServiceClient client, IMember user) throws ServiceNotAvailableException {
        super(form);
        this.client = client;
        this.user = user;
